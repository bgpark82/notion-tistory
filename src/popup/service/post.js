...
import {BlockListRequest} from "../api/notion/BlockListRequest";
import {PostSaveRequest} from "../api/tistory/PostSaveRequest";
...
class PostService {
    ...
    async post(blockId, blockTitle) {
        ...
        return await tistoryApi.post(new PostSaveRequest(blockTitle, content, 'bgpark', TISTORY_ACCESS_TOKEN));
    }
}
